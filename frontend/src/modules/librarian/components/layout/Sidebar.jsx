...
import { LogOut, BookOpen, ChevronLeft, Menu } from 'lucide-react';
      ...
      <div>
        <div className="h-16 px-6 border-b border-slate-900 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-bold text-sm tracking-wide block">LMS PORTAL</span>
              <span className="text-3xs text-amber-500 font-bold uppercase tracking-wider block">School Library</span>
            </div>
          </div>
          <button 
