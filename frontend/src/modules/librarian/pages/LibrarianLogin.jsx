    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-slate-950/80 border border-slate-800 rounded-3xl p-8 backdrop-blur-md shadow-2xl relative z-10 space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex p-3.5 bg-amber-500 rounded-2xl text-white shadow-lg shadow-amber-500/20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-11 pl-10 pr-4 bg-slate-900 border border-slate-850 rounded-2xl text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-11 bg-amber-600 hover:bg-amber-700 disabled:bg-amber-600/50 text-white text-xs font-bold rounded-2xl transition-all duration-150 shadow-md shadow-amber-900/20 active:scale-98"
          >
        ...
        <div className="pt-2 text-center">
          ...
          <span className="text-3xs font-mono text-amber-500 bg-amber-500/5 px-3 py-1 rounded-full border border-amber-500/10">
            librarian / lib123
          </span>
        </div>
      </div>
