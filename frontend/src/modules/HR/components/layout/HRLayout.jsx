...
export const HRLayout = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-955">
        <div className="w-10 h-10 rounded-full border-t-2 border-rose-600 animate-spin"></div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 transition-colors duration-200 font-sans">
      {/* Desktop Sidebar */}
