        ...
        <div className={cn("flex items-center", isCollapsed ? "justify-center" : "gap-3")}>
          ...
          {!isCollapsed && (
            ...
            >
              ...
              <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold tracking-wider uppercase mt-1 block font-sans">HRMS Desk</span>
            </motion.div>
          )}
        </div>
        <button
              ...
              return (
                <NavLink
                  ...
                  className={cn(
                    ...
                    isActive 
                      ? "bg-rose-600 text-white shadow-lg shadow-rose-600/15 scale-[1.01]" 
