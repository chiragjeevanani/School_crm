...
export const SkeletonLoader = ({ variant = 'card', rows = 3, className }) => {
  ...
  if (variant === 'vehicle') {
    return (
      <div className={cn("border border-slate-202 dark:border-slate-800 bg-white dark:bg-slate-900 rounded-2xl p-5 flex gap-4 animate-pulse", className)}>
        <div className="w-20 h-16 bg-slate-200 dark:bg-slate-850 rounded-xl shrink-0" />
