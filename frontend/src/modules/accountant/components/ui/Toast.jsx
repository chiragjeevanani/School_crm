...
const Toast = ({ message, type = 'success', onClose, duration = 3000 }) => {
  ...
  const icons = {
    ...
    info: <Info className="w-4 h-4 text-sky-600 dark:text-sky-450" />
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 pointer-events-none">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="p-0.5 hover:bg-black/5 dark:hover:bg-white/5 rounded text-slate-400 hover:text-slate-650"
        >
