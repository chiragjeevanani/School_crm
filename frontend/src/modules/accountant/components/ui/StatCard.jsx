...
export const StatCard = ({ title, value, subtitle, icon: Icon, trend, className }) => {
  ...
  return (
    <div className={cn(
      "bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all duration-205 flex flex-col justify-between",
      className
    )}>
      <div className="flex items-start justify-between">
        ...
        {Icon && (
          <div className="p-3 bg-violet-50 dark:bg-violet-950/40 text-violet-600 dark:text-violet-405 rounded-2xl">
