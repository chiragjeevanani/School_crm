...
export const ParentMessages = () => {
  const { messages, addMessage } = useParentNotifications();
  ...
  return (
    <div className="space-y-0 -mx-4 -my-6 md:mx-0 md:my-0 md:space-y-6">
      ...
      <div className="md:hidden px-4 py-4 border-b border-border">
        <h2 className="text-lg font-black text-foreground">Conversations</h2>
        <p className="text-xs text-slate-500">Contact child's subject teachers or office administration</p>
      </div>

      <div className="hidden md:block">
        <h2 className="text-lg font-black text-foreground">Conversations</h2>
        <p className="text-xs text-slate-500 mt-0.5">Chat with subject teachers and administrative office staff</p>
      </div>
          ...
          {activeMessages ? (
            ...
            <div className="flex-1 flex items-center justify-center">
              <EmptyState
                ...
                description="Choose a teacher from the list to start messaging."
                icon={MessageSquare}
              />
            </div>
          )}
